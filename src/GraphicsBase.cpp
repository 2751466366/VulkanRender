...
VkResult GraphicsBase::CheckInstanceExtensions(std::span<const char*> extensionsToCheck, const char* layerName)
{
...
VkResult GraphicsBase::WaitIdle()
{
...
VkResult GraphicsBase::CreateSwapchain(VkExtent2D size, bool limitFrameRate, VkSwapchainCreateFlagsKHR flags)
{
    ...
    swapchainCreateInfo.imageExtent =
        ...
        VkExtent2D{
            glm::clamp(size.width, surfaceCapabilities.minImageExtent.width, surfaceCapabilities.maxImageExtent.width),
            glm::clamp(size.height, surfaceCapabilities.minImageExtent.height, surfaceCapabilities.maxImageExtent.height) } :
